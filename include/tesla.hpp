    ...
    namespace gfx {
        ...
        private:
            ...
            Result initFonts() {
                ...
                if(R_FAILED(res = plGetSharedFontByType(&stdChineseFontData, PlSharedFontType_ChineseSimplified)))
                    return res;
    ...
    namespace elm {
        ...
        public:
            ...
            virtual void draw(gfx::Renderer *renderer) override {
				...
				if (TeslaFPS == 60) renderer->drawString("\uE0E1  返回     \uE0E0  确认", false, 30, 693, 23, a(0xFFFF));
